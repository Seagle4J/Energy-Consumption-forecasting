...
2. Run the preprocessing and feature engineering blocks
3. Train all models (LR, RF, XGBoost, Voting, Stacking)
4. Evaluate performance and generate plots
5. Run the testing code for unseen data
